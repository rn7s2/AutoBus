...
void AutoBus::fcfs_primary_request(int direction, int station)
{
    if (direction == -1) {
...
void AutoBus::fcfs_secondary_request(int target)
{
...
void AutoBus::fcfs_clockwise_go()
{
...
void AutoBus::fcfs_counterclockwise_go()
{
    state.position++; // move position
...
void AutoBus::fcfs_request_complete(int station)
{
...
// target reached, set next one
void AutoBus::fcfs_set_next_target(int station)
{
